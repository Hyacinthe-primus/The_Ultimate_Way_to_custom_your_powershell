...
$config.logo.color  = [PSCustomObject]@{
    "1" = $randomPalette["1"]; "2" = $randomPalette["2"]; "3" = $randomPalette["3"]
    "4" = $randomPalette["4"]; "5" = $randomPalette["5"]; "6" = $randomPalette["6"]
    "7" = $randomPalette["7"]; "8" = $randomPalette["8"]; "9" = $randomPalette["9"]
}
